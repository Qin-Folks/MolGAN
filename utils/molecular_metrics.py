...
NP_model = pickle.load(gzip.open('../MolGAN-pytorch/data/NP_score.pkl.gz'))
SA_model = {i[j]: float(i[0]) for i in pickle.load(gzip.open('../MolGAN-pytorch/data/SA_score.pkl.gz')) for j in range(1, len(i))}
